...
class QuantTradingStrategy:
        ...
        try:
            if str(data_source).lower() == 'coarse_grain':
                ...
                (self.X_all, X_train, self.y_train, self.ret_train, 
                 ...
                 self.z_index, ohlc) = dataload.data_prepare_coarse_grain_rolling(
    ...
    def train_models(self):
        ...
        lr_model.fit(self.X_train, self.ret_train.reshape(-1, 1))
    ...
    def run_full_pipeline(self, weight_method='equal'):
        """
        运行完整的策略流程
