...
```bash
# 一键安装（会自动检测 Python 版本并安装缺失组件）
bash setup_env.sh
```

该脚本会自动完成：
1. ✅ 检测系统 Python 版本（支持 3.8+，包括 3.12）
2. ✅ 如果版本满足但缺少 venv 模块，自动安装对应版本的 venv
3. ✅ 如果版本过低或没有 Python，安装 Python 3.8
4. ✅ 创建虚拟环境
5. ✅ 安装所有依赖包
6. ✅ 验证安装结果
