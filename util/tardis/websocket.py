...
from cryptofeed.exchanges import Bitmex, BinanceFutures
...
def main():
    ...
    f.add_feed(BinanceFutures(symbols=['ETH-USDT-PERP'], channels=[L2_BOOK], callbacks={L2_BOOK: BookCallback(book)}))
    f.run()
